/** Palforge — app shell: bottom tabs + More hub, error boundary.
 *
 * Navigation follows the evidence (docs/04_PRODUCT_BLUEPRINT.md): the daily
 * tools sit on the tab bar (Apple HIG's reachable-thumb pattern, what Dododex
 * and HoYoLAB ship), and everything else — Reference, future sections,
 * profiles — lives one tap away in the More hub. No hamburger: hidden
 * navigation measurably hides features.
 */
...
type Tab = 'calc' | 'plan' | 'odds' | 'paldex' | 'more';
